...
Creature::Creature(int __x, int __y, int __width, int __height, int __hp)
    : _width(__width), _height(__height), _hp(__hp), _dx(0), _dy(0), _speed(0.1), _on_ground(false), _up_is_pressed(false), _alive(true)
{
    box.left = __x;
    box.top = __y;
